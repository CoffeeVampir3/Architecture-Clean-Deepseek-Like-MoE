...
def main():
    inference = MoEInference(model_path="/home/grail/Desktop/moexperiments/moed/checkpoints/checkpoint_epoch_10.safetensors")
    result = inference.generate("Four score and")
    print(result)
